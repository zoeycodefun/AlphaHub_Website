...
const EXCHANGES: Exchange[] = [
    ...
    { id: 'bybit', name: 'Bybit', type: 'CEX', isConnected: false},
    { id: 'gate', name: 'Gate.io', type: 'CEX', isConnected: false},
    // DEX
    { id: 'hyperliquid', name: 'Hyperliquid', type: 'DEX', isConnected: false},
    { id: 'uniswap', name: 'Uniswap', type: 'DEX', isConnected: false},
    { id: 'sushiswap', name: 'SushiSwap', type: 'DEX', isConnected: false},
    { id: 'pancakeswap', name: 'PancakeSwap', type: 'DEX', isConnected: false},
